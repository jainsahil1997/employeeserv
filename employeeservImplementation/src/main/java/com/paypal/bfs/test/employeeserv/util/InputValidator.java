...
import com.paypal.bfs.test.employeeserv.util.Errors;
...
public class InputValidator {
    ...
    private void checkForRequired(Employee employeeRequest, List<Errors> errorsList) {
        //last name
        //first name
        if(isIntEmpty(employeeRequest.getId())){
            errorsList.add(Errors.builder().field(ID).message(REQUIRED).build());
        }
    ...
    private boolean isIntEmpty(Integer value){return null == value;}
}
